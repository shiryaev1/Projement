...
urlpatterns = [
    ...
    url(r'^projects/create/$', ProjectCreateView.as_view(),
        name='project-create'),
    url(r'^projects/(?P<pk>[0-9]+)-(?P<slug>[-\w]*)/update$',
        ProjectUpdateView.as_view(), name='project-update'),
    url(r'^history/$', HistoryOfChangesView.as_view(),
        name='history-of-changes'),
    url(r'^history/(?P<pk>[0-9]+)-(?P<id>[0-9]+)/$',
        HistoryOfChangesDetailView.as_view(),
        name='history-of-changes-detail'),
    url(r'^tag/create/$', TagCreate.as_view(),
        name='tag-create'),
    url(r'^tag/(?P<pk>\d+)/edit/$', TagEditView.as_view(),
        name='tag-edit'),
